...
// Check AI mode - set by content-v4.js
const AI_MODE = document.documentElement.getAttribute('data-ai-mode') || 'free';
console.log('[AIinjected] 📌 Mode detected:', AI_MODE);

// Only do Prompt API detection if in SMART mode
if (AI_MODE !== 'smart') {
  console.log('[AIinjected] 💰 FREE mode - skipping Prompt API detection');
} else {
  // Retry detection - check if API becomes available later (SMART mode only)
